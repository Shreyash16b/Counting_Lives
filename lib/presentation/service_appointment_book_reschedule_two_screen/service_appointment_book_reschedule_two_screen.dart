...
class ServiceAppointmentBookRescheduleTwoScreen extends StatelessWidget {
  ServiceAppointmentBookRescheduleTwoScreen({Key? key}) : super(key: key);
                ...
                child: SingleChildScrollView(
                    child: SizedBox(
                        ...
                        child:
                          ...
                          _buildModernDiagnostic(context),
  ...
  /// Section Widget
  Widget _buildModernDiagnostic(BuildContext context) {
    return Align(
                          ...
                          children: [
                            ...
                            Row(children: [
                              ...
                              Padding(
                                  ...
                                  child: Text("Tuesday, 24th September 2020 ",
                                      style:
                                          CustomTextStyles.bodySmallGray70010))
                            ])
                          ]))
  ...
  Widget _buildCalendar(BuildContext context) {
    return Align(
        ...
        child: Padding(
            padding: EdgeInsets.only(left: 26.h, right: 26.h, bottom: 72.v),
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Column(children: [
                  ...
                  Container(
                      ...
                      child: Row(
                          ...
                          children: [
                            Text("SUN",
                                style: CustomTextStyles.mulishGray8004c),
                            Text("MON",
                                style: CustomTextStyles.mulishGray8004c),
                            Text("TUE",
                                style: CustomTextStyles.mulishGray8004c),
                ...
                Column(children: [
                  Container(
                      ...
                      decoration: AppDecoration.fillGray40002.copyWith(
              ...
              Container(
                  padding:
                      EdgeInsets.symmetric(horizontal: 118.h, vertical: 10.v),
  ...
  Widget _buildConfirm(BuildContext context) {
    return Container(
        padding: EdgeInsets.symmetric(horizontal: 26.h, vertical: 35.v),
        ...
        child: Column(children: [
          ...
          RichText(
              text: TextSpan(children: [
                TextSpan(
                    text: "For ", style: CustomTextStyles.bodyLargeff4d4d4d),
                TextSpan(text: "X - Ray", style: theme.textTheme.titleMedium)
              ]),
          ...
          RichText(
              text: TextSpan(children: [
                ...
                TextSpan(text: "2 pm", style: theme.textTheme.titleMedium)
              ]),
              textAlign: TextAlign.left),
  ...
  /// Navigates to the serviceAppointmentBookRescheduleSuccessScreen when the action is triggered.
  onTapConfirm(BuildContext context) {
    Navigator.pushNamed(
        context, AppRoutes.serviceAppointmentBookRescheduleSuccessScreen);
  }
}
