import 'package:counting_lives/Constants/constants.dart';
import 'package:counting_lives/Helper/HelperFunctions.dart';
import 'package:counting_lives/pages/Hospital/hospitalSignUp2.dart';
                        ...
                        child: TextFormField(
                          ...
                          decoration: const InputDecoration(
                              ...
                              labelStyle: TextStyle(
                                  color: Constants.pink2, fontSize: 10),
                              hintStyle: TextStyle(
                                  color: Color.fromARGB(174, 51, 51, 51),
                                  fontWeight: FontWeight.w200)),
                          validator: (value) {
